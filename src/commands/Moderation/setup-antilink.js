...
const linkSchema = require("../../schems/antilink"); // Remember to fix the file paths if it does not match yours.
const antilinkLogSchema = require("../../schems/antilinkLogChannel");
